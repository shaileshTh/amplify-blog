...
export default function MyResponsiveNav(props) {
  ...
  const variants = [
    ...
    },
    {
      overrides: {
        ...
        Jobs: {},
        Applicants: {},
        "Frame 32136562867": { gap: "11px", width: "92px" },
        image: {},
        "Frame 32136562871": { gap: "29px", width: "267px" },
        MyResponsiveNav: { gap: "9px", padding: "24px 30px 24px 6px" },
      },
    ...
    },
    {
      overrides: {
        ...
        Jobs: {},
        Applicants: {},
        "Frame 32136562867": { width: "296.5px" },
        image: {},
        "Frame 32136562871": { width: "296.5px" },
        MyResponsiveNav: { gap: "20px" },
      },
    ...
    },
    {
      overrides: {
        ...
        Jobs: {},
        Applicants: {},
        "Frame 32136562867": { width: "532px" },
        image: {},
        "Frame 32136562871": { width: "532px" },
        MyResponsiveNav: {},
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "MyResponsiveNav")}
      {...rest}
    >
      <Flex
        gap="2px"
        ...
        display="flex"
        {...getOverrideProps(overrides, "Logo36562864")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Logo"
          {...getOverrideProps(overrides, "Logo36562866")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        padding="0px 0px 0px 0px"
        display="flex"
        {...getOverrideProps(overrides, "Frame 32136562867")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        padding="0px 0px 0px 0px"
        display="flex"
        {...getOverrideProps(overrides, "Frame 32136562871")}
      >
        <Image
          width="45px"
          height="45px"

...
export default function MyHeroLayout1(props) {
  ...
  const variants = [
    ...
    },
    {
      overrides: {
        ...
        Button: {},
        HeroMessage: {},
        Left: { padding: "120px 1px 120px 1px" },
        image: {},
        Right: {},
        MyHeroLayout1: { width: "628px", height: "unset" },
      },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "MyHeroLayout1")}
      {...rest}
    >
      <Flex
        gap="10px"

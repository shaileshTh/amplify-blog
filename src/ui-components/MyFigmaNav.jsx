...
export default function MyFigmaNav(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "MyFigmaNav")}
      {...rest}
    >
      <View
        padding="0px 0px 0px 0px"
